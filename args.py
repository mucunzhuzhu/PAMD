...
def parse_train_opt():
    ...
    parser.add_argument("--data_path", type=str, default="/data/zhuying/PAMD-main/data/", help="raw data path")
    parser.add_argument(
        "--processed_data_dir",
        type=str,
...
def parse_test_opt():
    ...
    parser.add_argument(
        "--edit_render_dir", type=str, default="renders_edit", help="Sample render path"
    )
    parser.add_argument("--feature_type", type=str, default="jukebox")
