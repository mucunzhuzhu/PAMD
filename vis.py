...
def plot_single_pose(num, poses, lines, ax, axrange, scat, contact):
    ...
    if num == 0:
        ...
        x_min, x_max = xcenter - stepx, xcenter + stepx # 0-1.5, 0+1.5
        y_min, y_max = ycenter - stepy, ycenter + stepy # 0-1.5, 0+1.5
        z_min, z_max = zcenter - stepz, zcenter + stepz # 2.5-2.5=1, 2.5+1.5=4
